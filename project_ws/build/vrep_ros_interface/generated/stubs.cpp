...
bool registerScriptStuff()
{
    try
    {
        ...
        try
        {
            ...
            simRegisterScriptVariableE("simROS.reportedDeprecatedFunctionNames", "{}", -1);
            simRegisterScriptVariableE("simROS.reportDeprecatedFunction",
                    "function(oldName,newName)\n"
                    "    if simROS.reportedDeprecatedFunctionNames[oldName]~=nil then return end\n"
                    "    msg='WARNING: %s is deprecated, please use %s.'\n"
                    //"    simAddStatusbarMessage(string.format(msg, oldName, newName))\n"
                    "    simROS.reportedDeprecatedFunctionNames[oldName]=true\n"
                    "end", -1);
            simRegisterScriptVariableE("simROS.deprecated",
                    "function(oldName,newName,f)\n"
                    "    return function(...)\n"
                    "        simROS.reportDeprecatedFunction(oldName,newName)\n"
                    "        return f(...)\n"
                    "    end\n"
                    "end", -1);
            ...
            simRegisterScriptVariableE("simExtRosInterface_subscribe", "simROS.deprecated('simExtRosInterface_subscribe','simROS.subscribe',simROS.subscribe)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_subscribe@RosInterface", "number subscriberHandle=simExtRosInterface_subscribe(string topicName,string topicType,string topicCallback,number queueSize=1)\n\n(DEPRECATED, please use simROS.subscribe)", 0);
            simRegisterScriptVariableE("simExtRosInterface_shutdownSubscriber", "simROS.deprecated('simExtRosInterface_shutdownSubscriber','simROS.shutdownSubscriber',simROS.shutdownSubscriber)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_shutdownSubscriber@RosInterface", "simExtRosInterface_shutdownSubscriber(number subscriberHandle)\n\n(DEPRECATED, please use simROS.shutdownSubscriber)", 0);
            simRegisterScriptVariableE("simExtRosInterface_subscriberTreatUInt8ArrayAsString", "simROS.deprecated('simExtRosInterface_subscriberTreatUInt8ArrayAsString','simROS.subscriberTreatUInt8ArrayAsString',simROS.subscriberTreatUInt8ArrayAsString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_subscriberTreatUInt8ArrayAsString@RosInterface", "simExtRosInterface_subscriberTreatUInt8ArrayAsString(number subscriberHandle)\n\n(DEPRECATED, please use simROS.subscriberTreatUInt8ArrayAsString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_advertise", "simROS.deprecated('simExtRosInterface_advertise','simROS.advertise',simROS.advertise)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_advertise@RosInterface", "number publisherHandle=simExtRosInterface_advertise(string topicName,string topicType,number queueSize=1,bool latch=false)\n\n(DEPRECATED, please use simROS.advertise)", 0);
            simRegisterScriptVariableE("simExtRosInterface_shutdownPublisher", "simROS.deprecated('simExtRosInterface_shutdownPublisher','simROS.shutdownPublisher',simROS.shutdownPublisher)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_shutdownPublisher@RosInterface", "simExtRosInterface_shutdownPublisher(number publisherHandle)\n\n(DEPRECATED, please use simROS.shutdownPublisher)", 0);
            simRegisterScriptVariableE("simExtRosInterface_publisherTreatUInt8ArrayAsString", "simROS.deprecated('simExtRosInterface_publisherTreatUInt8ArrayAsString','simROS.publisherTreatUInt8ArrayAsString',simROS.publisherTreatUInt8ArrayAsString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_publisherTreatUInt8ArrayAsString@RosInterface", "simExtRosInterface_publisherTreatUInt8ArrayAsString(number publisherHandle)\n\n(DEPRECATED, please use simROS.publisherTreatUInt8ArrayAsString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_publish", "simROS.deprecated('simExtRosInterface_publish','simROS.publish',simROS.publish)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_publish@RosInterface", "simExtRosInterface_publish(number publisherHandle,table message)\n\n(DEPRECATED, please use simROS.publish)", 0);
            simRegisterScriptVariableE("simExtRosInterface_serviceClient", "simROS.deprecated('simExtRosInterface_serviceClient','simROS.serviceClient',simROS.serviceClient)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_serviceClient@RosInterface", "number serviceClientHandle=simExtRosInterface_serviceClient(string serviceName,string serviceType)\n\n(DEPRECATED, please use simROS.serviceClient)", 0);
            simRegisterScriptVariableE("simExtRosInterface_shutdownServiceClient", "simROS.deprecated('simExtRosInterface_shutdownServiceClient','simROS.shutdownServiceClient',simROS.shutdownServiceClient)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_shutdownServiceClient@RosInterface", "simExtRosInterface_shutdownServiceClient(number serviceClientHandle)\n\n(DEPRECATED, please use simROS.shutdownServiceClient)", 0);
            simRegisterScriptVariableE("simExtRosInterface_serviceClientTreatUInt8ArrayAsString", "simROS.deprecated('simExtRosInterface_serviceClientTreatUInt8ArrayAsString','simROS.serviceClientTreatUInt8ArrayAsString',simROS.serviceClientTreatUInt8ArrayAsString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_serviceClientTreatUInt8ArrayAsString@RosInterface", "simExtRosInterface_serviceClientTreatUInt8ArrayAsString(number serviceClientHandle)\n\n(DEPRECATED, please use simROS.serviceClientTreatUInt8ArrayAsString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_call", "simROS.deprecated('simExtRosInterface_call','simROS.call',simROS.call)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_call@RosInterface", "table result=simExtRosInterface_call(number serviceClientHandle,table request)\n\n(DEPRECATED, please use simROS.call)", 0);
            simRegisterScriptVariableE("simExtRosInterface_advertiseService", "simROS.deprecated('simExtRosInterface_advertiseService','simROS.advertiseService',simROS.advertiseService)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_advertiseService@RosInterface", "number serviceServerHandle=simExtRosInterface_advertiseService(string serviceName,string serviceType,string serviceCallback)\n\n(DEPRECATED, please use simROS.advertiseService)", 0);
            simRegisterScriptVariableE("simExtRosInterface_shutdownServiceServer", "simROS.deprecated('simExtRosInterface_shutdownServiceServer','simROS.shutdownServiceServer',simROS.shutdownServiceServer)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_shutdownServiceServer@RosInterface", "simExtRosInterface_shutdownServiceServer(number serviceServerHandle)\n\n(DEPRECATED, please use simROS.shutdownServiceServer)", 0);
            simRegisterScriptVariableE("simExtRosInterface_serviceServerTreatUInt8ArrayAsString", "simROS.deprecated('simExtRosInterface_serviceServerTreatUInt8ArrayAsString','simROS.serviceServerTreatUInt8ArrayAsString',simROS.serviceServerTreatUInt8ArrayAsString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_serviceServerTreatUInt8ArrayAsString@RosInterface", "simExtRosInterface_serviceServerTreatUInt8ArrayAsString(number serviceServerHandle)\n\n(DEPRECATED, please use simROS.serviceServerTreatUInt8ArrayAsString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_sendTransform", "simROS.deprecated('simExtRosInterface_sendTransform','simROS.sendTransform',simROS.sendTransform)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_sendTransform@RosInterface", "simExtRosInterface_sendTransform(table transform)\n\n(DEPRECATED, please use simROS.sendTransform)", 0);
            simRegisterScriptVariableE("simExtRosInterface_sendTransforms", "simROS.deprecated('simExtRosInterface_sendTransforms','simROS.sendTransforms',simROS.sendTransforms)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_sendTransforms@RosInterface", "simExtRosInterface_sendTransforms(table transforms)\n\n(DEPRECATED, please use simROS.sendTransforms)", 0);
            simRegisterScriptVariableE("simExtRosInterface_imageTransportSubscribe", "simROS.deprecated('simExtRosInterface_imageTransportSubscribe','simROS.imageTransportSubscribe',simROS.imageTransportSubscribe)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_imageTransportSubscribe@RosInterface", "number subscriberHandle=simExtRosInterface_imageTransportSubscribe(string topicName,string topicCallback,number queueSize=1)\n\n(DEPRECATED, please use simROS.imageTransportSubscribe)", 0);
            simRegisterScriptVariableE("simExtRosInterface_imageTransportShutdownSubscriber", "simROS.deprecated('simExtRosInterface_imageTransportShutdownSubscriber','simROS.imageTransportShutdownSubscriber',simROS.imageTransportShutdownSubscriber)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_imageTransportShutdownSubscriber@RosInterface", "simExtRosInterface_imageTransportShutdownSubscriber(number subscriberHandle)\n\n(DEPRECATED, please use simROS.imageTransportShutdownSubscriber)", 0);
            simRegisterScriptVariableE("simExtRosInterface_imageTransportAdvertise", "simROS.deprecated('simExtRosInterface_imageTransportAdvertise','simROS.imageTransportAdvertise',simROS.imageTransportAdvertise)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_imageTransportAdvertise@RosInterface", "number publisherHandle=simExtRosInterface_imageTransportAdvertise(string topicName,number queueSize=1)\n\n(DEPRECATED, please use simROS.imageTransportAdvertise)", 0);
            simRegisterScriptVariableE("simExtRosInterface_imageTransportShutdownPublisher", "simROS.deprecated('simExtRosInterface_imageTransportShutdownPublisher','simROS.imageTransportShutdownPublisher',simROS.imageTransportShutdownPublisher)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_imageTransportShutdownPublisher@RosInterface", "simExtRosInterface_imageTransportShutdownPublisher(number publisherHandle)\n\n(DEPRECATED, please use simROS.imageTransportShutdownPublisher)", 0);
            simRegisterScriptVariableE("simExtRosInterface_imageTransportPublish", "simROS.deprecated('simExtRosInterface_imageTransportPublish','simROS.imageTransportPublish',simROS.imageTransportPublish)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_imageTransportPublish@RosInterface", "simExtRosInterface_imageTransportPublish(number publisherHandle,string data,number width,number height,string frame_id)\n\n(DEPRECATED, please use simROS.imageTransportPublish)", 0);
            simRegisterScriptVariableE("simExtRosInterface_getTime", "simROS.deprecated('simExtRosInterface_getTime','simROS.getTime',simROS.getTime)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_getTime@RosInterface", "number time=simExtRosInterface_getTime(number flag=0)\n\n(DEPRECATED, please use simROS.getTime)", 0);
            simRegisterScriptVariableE("simExtRosInterface_getParamString", "simROS.deprecated('simExtRosInterface_getParamString','simROS.getParamString',simROS.getParamString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_getParamString@RosInterface", "bool exists,string value=simExtRosInterface_getParamString(string name,string defaultValue='')\n\n(DEPRECATED, please use simROS.getParamString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_getParamInt", "simROS.deprecated('simExtRosInterface_getParamInt','simROS.getParamInt',simROS.getParamInt)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_getParamInt@RosInterface", "bool exists,number value=simExtRosInterface_getParamInt(string name,number defaultValue=0)\n\n(DEPRECATED, please use simROS.getParamInt)", 0);
            simRegisterScriptVariableE("simExtRosInterface_getParamDouble", "simROS.deprecated('simExtRosInterface_getParamDouble','simROS.getParamDouble',simROS.getParamDouble)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_getParamDouble@RosInterface", "bool exists,number value=simExtRosInterface_getParamDouble(string name,number defaultValue=0.0)\n\n(DEPRECATED, please use simROS.getParamDouble)", 0);
            simRegisterScriptVariableE("simExtRosInterface_getParamBool", "simROS.deprecated('simExtRosInterface_getParamBool','simROS.getParamBool',simROS.getParamBool)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_getParamBool@RosInterface", "bool exists,bool value=simExtRosInterface_getParamBool(string name,bool defaultValue=false)\n\n(DEPRECATED, please use simROS.getParamBool)", 0);
            simRegisterScriptVariableE("simExtRosInterface_setParamString", "simROS.deprecated('simExtRosInterface_setParamString','simROS.setParamString',simROS.setParamString)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_setParamString@RosInterface", "simExtRosInterface_setParamString(string name,string value)\n\n(DEPRECATED, please use simROS.setParamString)", 0);
            simRegisterScriptVariableE("simExtRosInterface_setParamInt", "simROS.deprecated('simExtRosInterface_setParamInt','simROS.setParamInt',simROS.setParamInt)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_setParamInt@RosInterface", "simExtRosInterface_setParamInt(string name,number value)\n\n(DEPRECATED, please use simROS.setParamInt)", 0);
            simRegisterScriptVariableE("simExtRosInterface_setParamDouble", "simROS.deprecated('simExtRosInterface_setParamDouble','simROS.setParamDouble',simROS.setParamDouble)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_setParamDouble@RosInterface", "simExtRosInterface_setParamDouble(string name,number value)\n\n(DEPRECATED, please use simROS.setParamDouble)", 0);
            simRegisterScriptVariableE("simExtRosInterface_setParamBool", "simROS.deprecated('simExtRosInterface_setParamBool','simROS.setParamBool',simROS.setParamBool)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_setParamBool@RosInterface", "simExtRosInterface_setParamBool(string name,bool value)\n\n(DEPRECATED, please use simROS.setParamBool)", 0);
            simRegisterScriptVariableE("simExtRosInterface_hasParam", "simROS.deprecated('simExtRosInterface_hasParam','simROS.hasParam',simROS.hasParam)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_hasParam@RosInterface", "bool exists=simExtRosInterface_hasParam(string name)\n\n(DEPRECATED, please use simROS.hasParam)", 0);
            simRegisterScriptVariableE("simExtRosInterface_deleteParam", "simROS.deprecated('simExtRosInterface_deleteParam','simROS.deleteParam',simROS.deleteParam)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_deleteParam@RosInterface", "simExtRosInterface_deleteParam(string name)\n\n(DEPRECATED, please use simROS.deleteParam)", 0);
            simRegisterScriptVariableE("simExtRosInterface_searchParam", "simROS.deprecated('simExtRosInterface_searchParam','simROS.searchParam',simROS.searchParam)", -1);
            simRegisterScriptCallbackFunctionE("simExtRosInterface_searchParam@RosInterface", "bool found,string name=simExtRosInterface_searchParam(string name)\n\n(DEPRECATED, please use simROS.searchParam)", 0);
